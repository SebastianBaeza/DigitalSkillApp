...
import usuarioIcono from './user.png';
import { getTiempoTranscurrido, setTiempoTranscurrido } from './globalVariables';
...
export function App() {
    ...
    return (
        <div className="app">
            <div className="sidebar">
                <ul>
                    <li><a href="/DigitalSkillApp/Seguridad/Simulador_Correos/Instrucciones">Instrucciones</a></li>
                    <li><a href="/DigitalSkillApp/Seguridad/Simulador_Correos/Bandeja">Bandeja de entrada</a></li>
                    <li><a href="/DigitalSkillApp/Seguridad/Simulador_Correos/Enviados">Elementos enviados</a></li>
                    <li><a href="/DigitalSkillApp/Seguridad/Simulador_Correos/Basurero">Elementos eliminados</a></li>
                </ul>
            </div>
            <div className="content">
                <Cronometro running={cronometroRunning} onTiempoTranscurrido={setTiempoTranscurrido} />
                {/* Contenido condicional según la ruta actual */}
                {window.location.pathname === '/DigitalSkillApp/Seguridad/Simulador_Correos/Instrucciones' && <Instrucciones />}
                {window.location.pathname === '/DigitalSkillApp/Seguridad/Simulador_Correos/Bandeja' && <Bandeja correos={correos} moveToTrash={moveToTrash} setCronometroRunning={setCronometroRunning} />}
                {window.location.pathname === '/DigitalSkillApp/Seguridad/Simulador_Correos/Enviados' && <Enviados />}
                {window.location.pathname === '/DigitalSkillApp/Seguridad/Simulador_Correos/Basurero' && <Basurero trash={trash} moveToInbox={moveToInbox} setEvaluacionTerminada={setEvaluacionTerminada} setCronometroRunning={setCronometroRunning} />}
                {/* Agregar más condiciones según las rutas necesarias */}
                {window.location.pathname === '/test-completado' && <TestCompletado tiempoTranscurrido={tiempoTranscurrido} />}
            </div>
            <div className="dropdown" onClick={toggleDropdown} onMouseLeave={closeDropdown}>
                <button className="dropdown-button">
                    <img className="usuario-icono" src={usuarioIcono} alt="user" />
